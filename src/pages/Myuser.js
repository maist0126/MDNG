...
function MyUser(propps) {
    ...
    useEffect(() => {  
        if (propps.state === 0){
            ...
            set({ top: '29.6vh' , left: '64.8vw', width: '24vmin', height: '24vmin', fontSize: '1rem', boxShadow: "0px 2px 4px 2px rgba(0, 0, 0, 0.233)"});
        } else if (propps.state === 3){
            set({ top: '29.6vh' , left: '51.3vw', width: '24vmin', height: '24vmin', fontSize: '1rem', boxShadow: "0px 2px 4px 2px rgba(0, 0, 0, 0.233)"});
        } else if (propps.state === 4){
            if (propps.radius === 3){
                set({ top: '29.6vh' , left: '37.8vw', width: '24vmin', height: '24vmin', fontSize: '1rem', boxShadow: "0px 4px 30px 6px rgba(255, 0, 255, 0.9)"});
            } else{
                set({ top: '29.6vh' , left: '37.8vw', width: '24vmin', height: '24vmin', fontSize: '1rem', boxShadow: "0px 2px 4px 2px rgba(0, 0, 0, 0.233)"});
            }
        } else if (propps.state === 5){
            set({ top: '50vh' , left: '14.25vw', width: '35vmin', height: '35vmin', fontSize: '1.25rem', boxShadow: "0px 2px 4px 2px rgba(0, 0, 0, 0.233)"});
        }
    });
    if (propps.id == 0){
        return (
